...
Line 8 `choiceTwo.calories = 150` since calories is private it cannot be used in SnackDriver class.
...
public class Book {
    ...
    public static void main(String[] args) {
        ...
        Book customBook = new Book("Diary of a Wimpy Kid: Dog Days", "Fiction", "Jeff Kinney", 185);
        System.out.println("\nCustom Book:");
...
course.setName("Math");
course.setGradeLevel("10th grade");
course.setPeriod(2);

String courseName = course.getName();
String courseGradeLevel = course.getGradeLevel();
int coursePeriod = course.getPeriod();
```
...
public class BankAccount {
    ...
    public static void main(String[] args) {
        ...
        BankAccount account = new BankAccount("Person 1", 5000.0);

        account.AccountHolder("Person 2");
...
```
    ...
    Account holder: Person 2
    Current balance: 5600.0
...
Answer: nextClassworkID and nextHomeworkID = static data. name and pointValue = instance data.
...
public class Assignment {
    ...
    public double getGrade() {
        if (pointValue == 0) {
            ...
            return (double) studentScore / pointValue * 100;
        }
    }

    public static void main(String[] args) {
        Assignment classwork = new Assignment("Classwork 1", 10);
        classwork.setStudentScore(8); 
        System.out.println("Grade for " + classwork.name + ": " + classwork.getGrade() + "%");
    }
}
Assignment.main(null);
```

    Grade for Classwork 1: 80.0%
...
public class Assignment {
    ...
    public static void main(String[] args) {
        Assignment rand = new Assignment("Doe", 23);
...
Answer: Both variables, it is non static.
...
This() in a constructor calls another constructor within the same class. The correct arguments must be passed when calling constructors with parameters. Using this() allows code to be reused between constructors.
