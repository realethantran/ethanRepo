...
- Note: Memory usage is insignificant nowadays
...
```
    ...
    Enter the first number: Enter the second number: Enter the operation (+ for addition, - for subtraction, * for multiplication): Result: 6.0
